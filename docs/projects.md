...
### 1. [Level 3 Bachelor Project - Rydberg Physics in Quantum Microwave-Optical Converters: A Qualitative Analysis](Physics%20Note%20Figures/Bachelor_Project__final_BSc_thesis_.pdf){ target="_blank" } { data-toc-label="Bachelor Project" }
...
### 2. [Level 3 Advanced Lab - Temperature Dependence of Band Gap Energies of Zinc Selenide and Silicon](Physics%20Note%20Figures/Advanced_Lab (1).pdf){ target="_blank" } { data-toc-label="Advanced Lab" }
...
### 3. [Level 2 Research-Led Investigation in Astronomy - The Role of Gravitational Perturbations in Determining Jupiter’s Mass: A Comparative Study of Io and Callisto](Physics%20Note%20Figures/Mass_of_Jupiter_V6.pdf){ target="_blank" } { data-toc-label="RLI" }
